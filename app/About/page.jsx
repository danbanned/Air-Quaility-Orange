        ...
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            ...
            <p className={styles.heroMission}>
              &ldquo;Bringing Black Stories to Light in Philadelphia and Beyond&rdquo;
            </p>
        ...
        <div className="container">
          ...
          <div className={styles.storyGrid}>
            <div className={styles.storyContent}>
              ...
              <p>
                Growing up in North Philly, I learned that our stories matter&mdash;even when mainstream media looks away.
              ...
              <p className={styles.storyQuote}>
                &ldquo;I make films because our stories are powerful. They can heal, inspire, and move people to action.&rdquo;
              </p>
            </div>
      ...
      >
        <div className="container">
          ...
          <div className={styles.personalQuote}>
            <blockquote>
              &ldquo;I didn&apos;t choose filmmaking&mdash;it chose me. As a young girl in North Philly, I knew I had stories to tell.
              Now, I&apos;m committed to creating space for others to tell theirs.&rdquo;
            </blockquote>
            <cite>&mdash; Ebony, Founder of Pearl&apos;s Girl Productions</cite>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className={styles.visionGrid}>
            ...
            <div className={styles.visionCard}>
              ...
              <p>Expanding PGP&apos;s reach to support more Black filmmakers and tell more stories that center our experiences&mdash;in all their complexity and joy.</p>
            </div>
            <div className={styles.visionCard}>
              <span className={styles.visionIcon}>📱</span>
          ...
          <div className={styles.contactGrid}>
            <div className={styles.contactInfo}>
              ...
              <p>
                ...
                or just want to chat about storytelling&mdash;I&apos;d love to hear from you.
              </p>
