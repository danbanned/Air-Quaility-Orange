...
const Problem = () => {
  const problems = [
    ...
    },
    {
      ...
      description: 'The concentration of pollution in Black and Latino neighborhoods is not accidental&mdash;it&apos;s the result of decades of discriminatory policies.',
      impacts: [
