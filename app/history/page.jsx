    ...
    <div className="container">
        ...
        <div className={styles.redliningContent}>
          <div className={styles.redliningText}>
            <p>
              ...
              &ldquo;mortgage security.&rdquo; Green areas were &ldquo;best&rdquo; for investment. Red areas were
              &ldquo;hazardous&rdquo; and marked for disinvestment.
            </p>
            <p>
      ...
      <div className={styles.legacySection}>
        ...
        <div className={styles.legacyGrid}>
          <div className={styles.legacyCard}>
            ...
            <p>Redlined areas are 5-12&deg;F hotter than non-redlined neighborhoods due to lack of trees and green space.</p>
          </div>
      ...
      <div className={styles.resistanceSection}>
        ...
        <div className={styles.resistanceQuotes}>
          <blockquote>
            &ldquo;We&apos;ve been fighting for clean air for generations. Now we&apos;re winning.&rdquo;
            <cite>- Hunting Park Block Captain</cite>
          </blockquote>

          <blockquote>
            &ldquo;The history is painful, but it shows us what we&apos;re capable of when we organize.&rdquo;
      ...
      <div className={styles.ctaSection}>
        ...
        <div className={styles.ctaButtons}>
          <Link href="/voices" className="btn">
